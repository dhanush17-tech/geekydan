  ...
  return (
    <nav className=" navbar relative flex px-5 my-5 md:px-10 md:my-8 justify-between items-center z-10  w-full ">
      ...
      {isMenuOpen === true ? (
        <>
          <div
            className={`  absolute  md:hidden  w-[80%] right-[11%] top-16 backdrop-filter backdrop-blur-lg bg-opacity-30 text-white bg-gray-500/5  border-4 border-white/50  rounded-lg  md:w-auto`}
            id="navbar-default"
          >
      ...
      <a href="#contact" className="hidden nav-hidden:flex border-4 border-blue font-[600] text-[21px] rounded-lg text-white px-3 py-1 ">
        Contact Me
      </a>
    </nav>
  );
